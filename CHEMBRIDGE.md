...
开发前先读 [Chembridge 统一开发与交付准则](DEVELOPMENT_PRINCIPLES.md)（2026-09-12.1）。这是跨对话默认约定：GitHub 发行、非开发者便捷安装、多 Agent/多模型、经济模型友好、**GPT-5.6 Terra + max 作为 benchmark**、按实际任务核实爱大标准、轻量快速、高效率与额度友好。具体证据、兼容矩阵和未完成项分别记录，不能把这些目标写成全部已达成。

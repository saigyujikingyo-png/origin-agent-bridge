...
第二设备的官方 Tunnel 客户端 0.0.14 已安装，下载摘要、版本、帮助和连接脚本语法检查通过；官方页面停在本人登录步骤。该设备尚未创建专用连接及凭据，不能把其本机协议客户端测试算作 Work 模型验收。第一设备的实际云端 Work 已通过，第二设备的实际云端 Work 仍未验收。状态接口中的 SR1 资格标记仍保留 pending，直到余下的宿主验证完成。

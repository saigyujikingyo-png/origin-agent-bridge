...
- **0.2.12 candidate:** Bounded connection readiness/health, ownership-fenced recovery and multi-account launcher migration. [Lifecycle and acceptance boundaries](docs/RUNTIME_LIFECYCLE.md).
